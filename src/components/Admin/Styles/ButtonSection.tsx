...
interface ButtonSectionProps {
  ...
  onStyleUpdate: (updates: Partial<StyleSettings>) => void;
}

export const ButtonSection = ({ styles, onStyleChange, onStyleUpdate }: ButtonSectionProps) => {
  return (
    <div className="space-y-6">
      <ButtonLibrary onSelectStyle={onStyleUpdate} />
