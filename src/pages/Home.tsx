    ...
    <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-6 md:py-8 space-y-4 sm:space-y-6 md:space-y-8 pb-20">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
        ...
        <Link to="/stats" className="flex h-full">
          <Card className="w-full h-full p-4 sm:p-6 hover:bg-accent transition-colors cursor-pointer border-2 border-transparent hover:border-primary/20 flex flex-col items-center justify-center">
